...
<div class="container">
    ...
    <div id="mydiv" class="field-wrap" style="float:left;padding-left: 50px; width: 40%;">
...
<div id="edit1" class="modalEdit">
    ...
    <form method="post">
        ...
        <button onclick="forgetPass()" class="button button-block">Update Your Password</button>
    </form>
</div>
